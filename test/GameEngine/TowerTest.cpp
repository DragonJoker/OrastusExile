...
namespace orastus
{
	namespace test
	{
		...
		void TowerTest::Creation()
		{
			...
			float speed{ 2.14f };
			uint32_t level{ 1u };
			auto tower = ecs.createTower( cooldown, damage, range, speed, level, nullptr, nullptr, nullptr );
			...
			auto splashTower = ecs.createTower( cooldown, damage, range, speed, splashDamage, splashRange, level, nullptr, nullptr, nullptr );
